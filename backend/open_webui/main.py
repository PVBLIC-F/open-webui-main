...
# Video/Audio Chunking
app.state.config.VIDEO_AUDIO_CHUNKING_STRATEGY = VIDEO_AUDIO_CHUNKING_STRATEGY
app.state.config.VIDEO_AUDIO_CHUNK_TARGET_DURATION = VIDEO_AUDIO_CHUNK_TARGET_DURATION
app.state.config.VIDEO_AUDIO_CHUNK_MAX_DURATION = VIDEO_AUDIO_CHUNK_MAX_DURATION
app.state.config.VIDEO_AUDIO_CHUNK_OVERLAP_DURATION = VIDEO_AUDIO_CHUNK_OVERLAP_DURATION
...
app.state.config.ENABLE_CHAPTER_GENERATION = ENABLE_CHAPTER_GENERATION
app.state.config.AUTO_GENERATE_CHAPTERS = AUTO_GENERATE_CHAPTERS


app.state.config.TITLE_GENERATION_PROMPT_TEMPLATE = TITLE_GENERATION_PROMPT_TEMPLATE
app.state.config.CHAPTER_GENERATION_PROMPT_TEMPLATE = CHAPTER_GENERATION_PROMPT_TEMPLATE
